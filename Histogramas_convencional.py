"""
Hace los histogramas con datos sinteticos usando el diseno convencional
"""
...
for N in range(1,37): #N es el numero de planta
    if N != 17: #No hay valores de referencia para la planta 17
        ...
        #%%
        #Cuantificacion de incertidumbre bayesiana
        ...
        fig.savefig(f"Histogramas/Diseno convencional sintetico/{plant_names[N-1]}.png", dpi=300, bbox_inches='tight')
