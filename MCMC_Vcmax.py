...
#%%
"Diseños para el MCMC"
dVcmax = [] #Lista para guardar lo diseños
for N in range(1,37): #Lista de plantas
    if N != 17:
        for val in [30,35,50,55,100,150]: #Lista de valores de V_{cmax}
            ...
            #Agregar a la lista (Valores de referencia, diseño, número de planta)
...
#%%
"Función para correr los MCMC para cada valor de V_{cmax}, diseño y planta"
def run_single_task(task):
    V, d_exp, N = task #Valores de referencia, diseño y número de planta
    ...
    #%%
    "Configuración para el diseño convencional"
    ...
    #%%
    "Configuración para el diseÃ±o de zigzag"
    dat = modelo.dataAll()
    ...
    #%%
    "Configuración para el diseÃ±o de rejilla"
    # Set-up experimental data
    mask = dat['Osp'] == 20 #Filtrar los datos de oxÃ­geno bajo
    #Niveles de oxigeno
    ...
    #%%
    #MCMC para el diseño convencional
    elif d_exp == "conv":
        #Cuantificación de incertidumbre bayesiana (sin datos)
    ...
    #%%
    #MCMC para el diseño de rejilla
    elif d_exp == "grid":
        #Cuantificación de incertidumbre bayesiana (sin datos)
...
#%%
"Ejecuta los MCMC en paralelo para las distintos diseños del experimento"
