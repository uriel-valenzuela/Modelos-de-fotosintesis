"Código para hacer los histogramas para los nuevos diseños"
...
#%%     
"Configuración para el diseño de rejilla"     
...
for N in range(1, 37):  #N es el número de planta
    if N!=17: #No hay valores de referencia para la planta 17
        ...
        #Valores sintéticos para ver los valores de referencia
        ...
        #%%
        "Histogramas de los parámetros (zigzag)"
        ...
        for k in range(15): #Son 15 parámetros
            ...
            buqzigzag.PlotPost(par=k, bins=15, burn_in=1_000_000, ax=ax) #Histograma graficado en la entrada k de la cuadricula
        ...
        fig.savefig(f"Histogramas/Diseño de zigzag/{plant_names[N]}.png", dpi=300, bbox_inches='tight')
        
        
        "Histogramas de los parámetros (rejila)"
        rcParams.update({
        "text.usetex": False,
        "font.family": "serif",
        "font.size": 12,
        ...
        for k in range(15):
            ax = axes[k]
            buqgrid.PlotPost(par=k, bins=15, burn_in=1_000_000, ax=ax)
            # Agregar letra del inciso
            letra = chr(97 + k)  # 97 es el código ASCII de 'a'
        ...
        tight_layout()
        fig.savefig(f"Histogramas/Diseño de rejilla/{plant_names[N]}.png"", dpi=300, bbox_inches='tight')
