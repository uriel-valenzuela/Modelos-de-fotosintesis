"Codigo para hacer los histogramas para los nuevos disenos"
...
for N in range(1, 37):  #N es el numero de planta
    if N!=17: #No hay valores de referencia para la planta 17
        ...
        #%%
        "Histogramas de los parametros (zigzag)"
        ...
        fig.savefig(f"Histogramas/Diseno de zigzag/{plant_names[N]}.png", dpi=300, bbox_inches='tight')
        
        
        "Histogramas de los parametros (rejila)"
        rcParams.update({
        "text.usetex": False,
        "font.family": "serif",
        "font.size": 12,
        ...
        tight_layout()
        fig.savefig(f"Histogramas/Diseno de rejilla/{plant_names[N-1]}.png", dpi=300, bbox_inches='tight')
