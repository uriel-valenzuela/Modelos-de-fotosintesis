...
buq.RunMCMC( T = 1_500_000, burn_in = 200_000, op_fnam = 'Corrida4.csv')
#%%
#buq.LoadtwalkOuput(op_fnam='Corrida3.csv')
buq.AnaMCMC(burn_in=800_000)
#%%

for k in range(0,15):
    buq.PlotPost(par=k, bins = 15)
