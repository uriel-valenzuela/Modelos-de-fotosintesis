...
#%%
"ConfiguraciÛn para el diseÒo de zigzag"
...
#Error para el diseÒo de zigzag
zigzag = pd.read_excel('./Zigzag.xlsx', header=[0]) #Lee el excel con los errores para el diseÒo de zigzag
sigma_zz = zigzag["Error"]

#%%     
"ConfiguraciÛn para el diseÒo de rejilla"     
...
#Error para el diseÒo de rejilla
grid = pd.read_excel('./Grid.xlsx', header=[0]) #Lee el excel con los errores para el diseÒo de rejilla
sigma_grid = grid["Error"]

#%%
q = 15 # Numero de parnmetros a inferir
logdensity=norm.logpdf #log-densidad del modelo
simdata = lambda n, loc, scale: norm.rvs( size=n, loc=loc, scale=scale) #Simula datos con la distribuciÛn normal
...
for N in range(1,37): #N es el n˙mero de planta
    if N != 17: #No hay valores de referencia para la planta 17
        ...
        #Agrega identificadores para los niveles de oxÌgeno
        ...
        #%%
        "Datos para el dise√±o de zigzag"
        dat = modelo.dataAll()
        ...
        #%%
        "Datos para el dise√±o de rejilla"
        # Set-up experimental data
        mask = dat['Osp'] == 20 #Filtrar los datos de ox√≠geno bajo
        #Niveles de oxigeno
        ...
        #Identificador de nivel de oxÌgeno
        ...
        #%%
        "SimulaciÛn de datos sintÈticos"
        #Valores de referencia para los par·metros
        ...
        #Listas para guardar los valores de los par√°metros de referencia
        ...
        fig.savefig(f"Histogramas/Discernir genotipos/Vcmax/{plant_names[N]}.png", dpi=300, bbox_inches='tight')    
        ...
        #Guardar la imagen con los histogramas
        fig.savefig(f"Histogramas/Discernir genotipos/Comparaciones Distancias/{plant_names[N]}.png", dpi=300, bbox_inches='tight')
        ...
        #Guardar la imagen con los histogramas
        fig.savefig(f"Histogramas/Discernir genotipos/Comparaciones Distancias cortas/{plant_names[N]}.png", dpi=300, bbox_inches='tight')
